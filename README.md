# claritas-viz organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`claritas-viz`](https://github.com/claritas-viz).

## Canonical organization links

- GitHub organization: https://github.com/claritas-viz
- Public organization defaults: https://github.com/claritas-viz/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomclaritas-viz-09fcc5d7dd9e
...
`claritas-viz` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
