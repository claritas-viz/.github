...
This GitHub account maintains software, infrastructure, research, and supporting documentation under the [`claritas-viz`](https://github.com/claritas-viz) GitHub owner.

Planning and delivery context is tracked in [github.com/claritas-viz](https://linear.app/denman/project/githubcomclaritas-viz-09fcc5d7dd9e). Public contribution, security, and governance defaults are maintained in [`.github`](https://github.com/claritas-viz/.github).
